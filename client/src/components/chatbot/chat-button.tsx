...
export default function ChatButton() {
  ...
  return (
    <>
      {/* Information Tooltip */}
      {showTooltip && !isOpen && (
        <Card className="fixed bottom-20 sm:bottom-24 left-2 sm:left-4 max-w-72 sm:max-w-64 shadow-xl border-2 border-pink-200 dark:border-pink-800 bg-background/95 backdrop-blur-sm z-[9998] animate-in slide-in-from-left-2 fade-in duration-300">
